...
$(function () {
    $('button.formbutton').click(function () {
        ...
        // получаем в переменную parent аттрибут data-parent
        var modal = $(this).attr('data-target')
        // получаем в переменную modal аттрибут data-target
        $(modal).find('input[name=target]').val(parent);
        // присваиваем инпуту с name=target значение из переменной parent
    })
});
